...
excel_file_path_name = r"C:\Users\asus\OneDrive\Documents\Full Web Development and Python Bootcamp\Python Tutorial\Snoflake Project\Python files\csv files\adjectives_nouns.csv"
excel_sheet_name = "adjectives_nouns"
adjective_column_name  = "Adjectives"
noun_column_name = "Noun"


#fetch this sheet data in a dataframe 

df = pd.read_csv(excel_file_path_name)
