...
excel_file_path_name = r"C:\Users\asus\OneDrive\Documents\Full Web Development and Python Bootcamp\Python Tutorial\Snoflake Project\Python files\LookupFile.xlsx"
...
df = pd.read_excel(excel_file_path_name, sheet_name=excel_sheet_name_product, engine="openpyxl")
df_cat = pd.read_excel(excel_file_path_name, sheet_name=excel_sheet_name_category, engine="openpyxl")
